 ...
 * @generated */
public class DoiBase extends RegularExpressionType {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(DoiBase.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected DoiBase() {/* intentionally empty block */}
   ...
   */
  public DoiBase(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public DoiBase(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
