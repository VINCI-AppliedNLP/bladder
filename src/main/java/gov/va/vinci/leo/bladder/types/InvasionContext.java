 ...
 * @generated */
public class InvasionContext extends AnnotationPatternType {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(InvasionContext.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected InvasionContext() {/* intentionally empty block */}
   ...
   */
  public InvasionContext(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
   ...
   */
  public InvasionContext(JCas jcas) {
    super(jcas);
    readObject();   
  } 
  ...
  */  
  public InvasionContext(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
