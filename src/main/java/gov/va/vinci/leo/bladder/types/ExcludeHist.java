 ...
 * @generated */
public class ExcludeHist extends Histology {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(ExcludeHist.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected ExcludeHist() {/* intentionally empty block */}
   ...
   */
  public ExcludeHist(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public ExcludeHist(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
