 ...
 * @generated */
public class DoiFlatValue extends DocVariable {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(DoiFlatValue.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected DoiFlatValue() {/* intentionally empty block */}
   ...
   */
  public DoiFlatValue(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public DoiFlatValue(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
