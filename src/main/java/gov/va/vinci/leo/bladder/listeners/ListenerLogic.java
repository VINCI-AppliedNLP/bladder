...
/**/
      ...
      int start = currAnnotation.getBegin() - 20;
      int end = currAnnotation.getEnd() + 20;
      if (start < 0)
        start = 0;
    ...
    currentDoc.put("Type", currAnnotation.getClass().getCanonicalName());
    //currentDoc.put("Snippets", shortenText(currAnnotation.getCoveredText(), 400, false));
    currentDoc.put("Snippets", snippet);
