 ...
 * @generated */
public class NegatedStage extends AnnotationPatternType {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(NegatedStage.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected NegatedStage() {/* intentionally empty block */}
   ...
   */
  public NegatedStage(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public NegatedStage(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
