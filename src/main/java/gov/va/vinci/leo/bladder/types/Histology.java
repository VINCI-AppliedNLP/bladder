 ...
 * @generated */
public class Histology extends RegularExpressionType {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(Histology.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected Histology() {/* intentionally empty block */}
   ...
   */
  public Histology(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public Histology(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
