 ...
 * @generated */
public class CisNo extends Cis {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(CisNo.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected CisNo() {/* intentionally empty block */}
   ...
   */
  public CisNo(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public CisNo(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
