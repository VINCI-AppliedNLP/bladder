 ...
 * @generated */
public class CisYes extends Cis {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(CisYes.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected CisYes() {/* intentionally empty block */}
   ...
   */
  public CisYes(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public CisYes(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
