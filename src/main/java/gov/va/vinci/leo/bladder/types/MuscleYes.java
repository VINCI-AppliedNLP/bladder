 ...
 * @generated */
public class MuscleYes extends Muscle {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(MuscleYes.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected MuscleYes() {/* intentionally empty block */}
   ...
   */
  public MuscleYes(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public MuscleYes(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
