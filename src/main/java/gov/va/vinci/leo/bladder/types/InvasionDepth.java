 ...
 * @generated */
public class InvasionDepth extends RegularExpressionType {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(InvasionDepth.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected InvasionDepth() {/* intentionally empty block */}
   ...
   */
  public InvasionDepth(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
   ...
   */
  public InvasionDepth(JCas jcas) {
    super(jcas);
    readObject();   
  } 
  ...
  */  
  public InvasionDepth(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
