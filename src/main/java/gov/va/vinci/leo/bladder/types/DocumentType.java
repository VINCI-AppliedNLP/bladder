 ...
 * @generated */
public class DocumentType extends RegularExpressionType {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(DocumentType.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected DocumentType() {/* intentionally empty block */}
   ...
   */
  public DocumentType(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public DocumentType(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
