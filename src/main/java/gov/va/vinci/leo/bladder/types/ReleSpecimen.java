 ...
 * @generated */
public class ReleSpecimen extends DocumentType {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(ReleSpecimen.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected ReleSpecimen() {/* intentionally empty block */}
   ...
   */
  public ReleSpecimen(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public ReleSpecimen(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
