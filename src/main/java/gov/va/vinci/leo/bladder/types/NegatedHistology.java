 ...
 * @generated */
public class NegatedHistology extends AnnotationPatternType {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(NegatedHistology.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected NegatedHistology() {/* intentionally empty block */}
   ...
   */
  public NegatedHistology(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
   ...
   */
  public NegatedHistology(JCas jcas) {
    super(jcas);
    readObject();   
  } 
  ...
  */  
  public NegatedHistology(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
