 ...
 */
public class GradeVal extends LeoBaseAnnotator {
    ...
    protected WindowService windowService = new WindowService(10, 10, Grade.class.getCanonicalName());
    ...
    public void process(JCas aJCas) throws AnalysisEngineProcessException {
        ...
        Collection<Grade> grades = AnnotationLibrarian.getAllAnnotationsOfType(aJCas, Grade.type, false);
     ...
     */
    protected boolean validGrade(Grade grade) throws Exception {
     ...
     * @param grade
     */
    protected void classifyNum(Grade grade) {
