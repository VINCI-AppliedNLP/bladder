...
public class MusclePipeline extends BasePipeline {


    public MusclePipeline() {
        ...
        try {
            annotators.add(new RegexAnnotator().getLeoAEDescriptor()
                    .setParameterSetting(RegexAnnotator.Param.GROOVY_CONFIG_FILE.getName(), "src/main/resources/muscle_regex.groovy")
          ...
          .addDelegate(new AnnotationPatternAnnotator().getLeoAEDescriptor()
              ...
              */
            //Muscle in specimen uses the same exclusion regex as the Histology pipeline
            annotators.add(new RegexAnnotator().getLeoAEDescriptor()
            ...
            annotators.add(new FilterAnnotator().getLeoAEDescriptor()
                    ...
                    .setParameterSetting(FilterAnnotator.Param.TYPES_TO_KEEP.getName(),
                            new String[]{"gov.va.vinci.leo.bladder.types.ExcludeHist",
                                    "gov.va.vinci.leo.bladder.types.MuscleNo"})
                    .setParameterSetting(FilterAnnotator.Param.TYPES_TO_DELETE.getName(),
                            new String[]{"gov.va.vinci.leo.bladder.types.MuscleYes"})
            ...
            annotators.add(new LogicAnnotator().getLeoAEDescriptor()
                    ...
                    .setParameterSetting(LogicAnnotator.Param.TYPE_NAME.getName(), new String[] {
                            "gov.va.vinci.leo.bladder.types.MuscleYes",
                            "gov.va.vinci.leo.bladder.types.MuscleNo"})
    ...
    public LeoTypeSystemDescription defineTypeSystem() {
        ...
        try {
            ...
            description.addType("gov.va.vinci.leo.bladder.types.Muscle", "Muscle", RegularExpressionType.class.getCanonicalName());
            description.addType("gov.va.vinci.leo.bladder.types.MuscleNo", "Muscle regex annotation","gov.va.vinci.leo.bladder.types.Muscle") ;
            description.addType("gov.va.vinci.leo.bladder.types.MuscleYes", "Muscle regex annotation", "gov.va.vinci.leo.bladder.types.Muscle")
