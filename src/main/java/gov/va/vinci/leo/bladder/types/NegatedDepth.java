 ...
 * @generated */
public class NegatedDepth extends AnnotationPatternType {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(NegatedDepth.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected NegatedDepth() {/* intentionally empty block */}
   ...
   */
  public NegatedDepth(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public NegatedDepth(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
