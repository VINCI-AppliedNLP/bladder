 ...
 * @generated */
public class Muscle extends RegularExpressionType {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(Muscle.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected Muscle() {/* intentionally empty block */}
   ...
   */
  public Muscle(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public Muscle(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
