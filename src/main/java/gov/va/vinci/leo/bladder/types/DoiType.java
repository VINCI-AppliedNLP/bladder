 ...
 * @generated */
public class DoiType extends RegularExpressionType {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(DoiType.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected DoiType() {/* intentionally empty block */}
   ...
   */
  public DoiType(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public DoiType(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
