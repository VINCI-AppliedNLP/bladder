 ...
 * @generated */
public class InvasionType extends RegularExpressionType {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(InvasionType.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected InvasionType() {/* intentionally empty block */}
   ...
   */
  public InvasionType(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public InvasionType(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
