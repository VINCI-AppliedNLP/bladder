 ...
 * @generated */
public class CIS_yes extends RefSt {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(CIS_yes.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected CIS_yes() {/* intentionally empty block */}
   ...
   */
  public CIS_yes(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public CIS_yes(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
