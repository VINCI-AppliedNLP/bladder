 ...
 * @generated */
public class Stage_t2 extends RefSt {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(Stage_t2.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected Stage_t2() {/* intentionally empty block */}
   ...
   */
  public Stage_t2(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public Stage_t2(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
