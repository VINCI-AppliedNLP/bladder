 ...
 * @generated */
public class CIS_no extends RefSt {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(CIS_no.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected CIS_no() {/* intentionally empty block */}
   ...
   */
  public CIS_no(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public CIS_no(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
