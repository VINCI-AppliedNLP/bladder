 ...
 * @generated */
public class Grade_1 extends RefSt {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(Grade_1.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected Grade_1() {/* intentionally empty block */}
   ...
   */
  public Grade_1(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public Grade_1(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
