 ...
 * @generated */
public class Stage_t3 extends RefSt {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(Stage_t3.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected Stage_t3() {/* intentionally empty block */}
   ...
   */
  public Stage_t3(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public Stage_t3(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
