 ...
 * @generated */
public class Stage_t1 extends RefSt {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(Stage_t1.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected Stage_t1() {/* intentionally empty block */}
   ...
   */
  public Stage_t1(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public Stage_t1(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
