 ...
 * @generated */
public class Grade_4 extends RefSt {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(Grade_4.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected Grade_4() {/* intentionally empty block */}
   ...
   */
  public Grade_4(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public Grade_4(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
