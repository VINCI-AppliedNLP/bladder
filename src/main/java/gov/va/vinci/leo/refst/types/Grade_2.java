 ...
 * @generated */
public class Grade_2 extends RefSt {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(Grade_2.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected Grade_2() {/* intentionally empty block */}
   ...
   */
  public Grade_2(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public Grade_2(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
