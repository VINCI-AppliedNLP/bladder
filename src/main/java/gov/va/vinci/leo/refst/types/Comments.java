 ...
 * @generated */
public class Comments extends RefSt {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(Comments.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected Comments() {/* intentionally empty block */}
   ...
   */
  public Comments(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public Comments(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
