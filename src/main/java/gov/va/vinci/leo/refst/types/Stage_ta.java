 ...
 * @generated */
public class Stage_ta extends RefSt {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(Stage_ta.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected Stage_ta() {/* intentionally empty block */}
   ...
   */
  public Stage_ta(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public Stage_ta(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
