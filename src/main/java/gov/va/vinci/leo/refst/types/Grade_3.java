 ...
 * @generated */
public class Grade_3 extends RefSt {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(Grade_3.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected Grade_3() {/* intentionally empty block */}
   ...
   */
  public Grade_3(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public Grade_3(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
